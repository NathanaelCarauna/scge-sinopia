...
As funcionalidades de Inteligência Artificial são fornecidas separadamente pela **extensão de browser SINOPIA**.

Para ativar a IA:
1. Instale a extensão localizada em `../extension/`
2. A extensão injeta automaticamente os componentes de IA nas páginas compatíveis

Consulte `../extension/README.md` para instruções de instalação.
